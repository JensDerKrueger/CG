...
{
	// TODO:
	// complete this method that adds a new element to the "elements" list to the corresponding octree leaf node
	// also take into account the maximum element count and the maximum octree depth
	//
	// split the octree node and set its warranty value to 20 when the maximum element count is reached
	// you can use the provided "computeCenter" and "subtreeIndex" methods to complete this method.
...
{
	// TODO:
	// complete this method that splits an octree node into 8 nodes
	// do not forget to fill the child nodes with the corresponding elements
